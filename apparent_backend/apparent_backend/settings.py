"""
Django settings for apparent_backend project.
...
SECRET_KEY = 'django-insecure-nj8m7r))6vc28+eyxv^xv*1lhg0%_xcpr3x^i4%x2g1^5gl81w'
...
ROOT_URLCONF = 'apparent_backend.urls'
...
WSGI_APPLICATION = 'apparent_backend.wsgi.application'
